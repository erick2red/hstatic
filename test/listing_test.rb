      ...
      <div class='container-fluid'>
        <div class='row'>
          <div class='col-md-4 col-md-offset-4'>
            <input autofocus class='form-control' placeholder='Search' type='text'>
          </div>
        </div>
        <div class='row'>
          <div class='col-lg-3 col-md-3 col-sm-3'>
            <div class='panel panel-default'>
              ...
              <div class='list-group'>
                <a class='list-group-item folder' href='/dummy_folder' title='dummy_folder'>dummy_folder</a>
              </div>
            </div>
          </div>
              ...
              <table class='table table-hover'>
                ...
                <tbody>
                  <tr>
                    <td>1</td>
                    <td>
                      <a href='/test_helper.rb'>test_helper.rb</a>
                    </td>
                    <td> 0.00 kB</td>
                  </tr>
                  <tr>
                    <td>2</td>
                    <td>
                      <a href='/template_test.rb'>template_test.rb</a>
                    </td>
                    <td> 0.00 kB</td>
                  </tr>
                  <tr>
                    <td>3</td>
                    <td>
                      <a href='/index_test.rb'>index_test.rb</a>
                    </td>
                    <td> 0.00 kB</td>
                  </tr>
                  <tr>
                    <td>4</td>
                    <td>
                      <a href='/listing_test.rb'>listing_test.rb</a>
                    </td>
                    <td> 4.00 kB</td>
                  </tr>
                </tbody>
